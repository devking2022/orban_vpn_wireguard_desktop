...
class WireGuardFlutterMethodChannel extends WireGuardFlutterInterface {
  ...
  static const _trafficEventChannel = EventChannel('billion.group.wireguard_flutter/traffic');
  ...
  Stream<Map<String, dynamic>> get trafficSnapshot =>
    _trafficEventChannel.receiveBroadcastStream().map((event) {
      ...
      return {"totalDownload": 0, "totalUpload": 0, "downloadSpeed": 0.0, "uploadSpeed": 0.0, "duration":"00:00:00"};
    });
